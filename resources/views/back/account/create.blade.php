                ...
                <div class="card-body">
                    <div class="mb-3">
                        <form action="{{ route('account-store') }}" method="post">
                            ...
                            <input type="email" class="form-control" name="email_post" placeholder="input email" value="{{ old('email_post') }}">


                            <label for="input" class="form-label">password</label>
                            <input type="password" class="form-control" name="password_post" placeholder="input password" value="{{ old('password_post') }}">
