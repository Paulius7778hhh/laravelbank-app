                        ...
                        <ul>
                            @forelse($Accountlist as $key => $account)
                                <form action="{{ route('account-edit', $account) }}" method="get">
                                    ...
                                    <li style="list-style: none;font-size: 15px;color:green;"><span
                                            style="color:darkgreen; font-size: 30px;">Name/</span> {{ $account->name }}
                                        ...
                                        {{ $account->accountid }} <span
                                            style="color:purple; font-size: 30px;">Balance/</span>
                                ...
                                <form action="{{ route('account-moneycount', $account) }}" method="get"> <button
                                        type="submit">+</button></form>


                                <form action="{{ route('account-account-balance', $account) }}" method="get"> <button
                                        type="submit">-</button></form>
